...
RAW_WG_OUTDIR="/private/groups/patenlab/mira/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/raw_wg/${sample_id}"
POL_WG_OUTDIR="/private/groups/patenlab/mira/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/pol_wg/${sample_id}"
RAW_CONF_OUTDIR="/private/groups/patenlab/mira/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/raw_conf/${sample_id}"
POL_CONF_OUTDIR="/private/groups/patenlab/mira/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/pol_conf/${sample_id}"
