...
cd /Users/miramastoras/Desktop/Paten_lab/phoenix_batch_submissions/polishing/annotate_edit_with_fp_kmers/HPRC_verkko_model1_no_filt_noTopOff/annotate_edit_with_fp_kmers_input_jsons
...
# move to working dir
mkdir -p /private/groups/patenlab/mira/hprc_polishing/hprc_int_asm/HPRC_verkko_model1_noTopOff/annotate_edit_with_fp_kmers
cd /private/groups/patenlab/mira/hprc_polishing/hprc_int_asm/HPRC_verkko_model1_noTopOff/annotate_edit_with_fp_kmers

## get files
cp -r /private/groups/patenlab/mira/phoenix_batch_submissions/polishing/annotate_edit_with_fp_kmers/HPRC_verkko_model1_no_filt_noTopOff/* ./
